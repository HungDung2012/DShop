                ...
                <div class="widget-row">
                    <div class="widget-row-col-1">
                        ...
                        <div class="widget-row-col-content">
                            <p>DShop là thương hiệu được thành lập vào năm 2022 với tiêu chí đặt chất lượng sản phẩm lên hàng đầu.</p>
                        </div>
                        ...
                        <div class="contact">
                            <div class="contact-item">
                                ...
                                <div class="contact-content">
                                    <span>96A Đ. Trần Phú, P. Mộ Lao, Hà Đông, Hà Nội, Việt Nam</span>
                                </div>
                            </div>
                            <div class="contact-item">
                                <div class="contact-item-icon">
                            ...
                            <div class="contact-item">
                                ...
                                <div class="contact-content conatct-item-email">
                                    <span>dungchuhung@gmail.com</span><br />
                                </div>
                            </div>
                        </div>
                    </div>
